...
import com.ifitmix.base.exception.RemoteCallException;
...
public class AppExceptionHandlerController extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> createResponseEntity(int code, int httpStatus, String requestUri, String message) {
